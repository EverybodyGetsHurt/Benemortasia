...
+ Ivo Mertens   | 2020-12-14 | v2.7     | Fixed "_" issue in Function Remove-CachedPackages             *
* IVo Mertens   | 2020-12-15 | v2.7.1   | Modified for use by Valid IT Infrastructures B.V.             *
********************************************************************************************************* 
...
## Configure Logging 
#  Set log path 
$ResultCSV = 'C:\Beheer\Scripts\Clean-CMClientCache\Clean-CMClientCache.log' 
 
#  Remove previous log if it's more than 500 KB 
